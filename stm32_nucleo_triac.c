...
uint32_t rpm = 0;
char uart_buffer[30];  // UART buffer for printing
/* USER CODE END PV */
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin) {
    if (GPIO_Pin == GPIO_PIN_0) {  // Zero-crossing detected (H11AA1 on PA0)
...
static void MX_TIM1_Init(void)
{
  ...
  htim1.Instance = TIM1;
  htim1.Init.Prescaler = 83;  // Set prescaler to 83 for 1MHz clock (1us ticks)
  htim1.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim1.Init.Period = 8332;  // Set ARR for 8.33ms period (half AC cycle)
...
static void MX_TIM3_Init(void)
{
  ...
  htim3.Instance = TIM3;
  htim3.Init.Prescaler = 83;  // Set prescaler to 83 for 1MHz clock (1us ticks)
  htim3.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim3.Init.Period = 8332;  // Set ARR for 8.33ms period (half AC cycle)
